...
function random_choice(color_seed) {
    ...
    if (color_seed == "rose") {
        ...
        if (random < 35) { imageNo = 0 }
        else if (random < 50) { imageNo = 1 }
        else if (random < 65) { imageNo = 2 }
        else if (random < 100) { imageNo = 3 }
        ...
        if (random < 40) { imageNo = 0 }
        else if (random < 60) { imageNo = 1 }
        else if (random < 100) { imageNo = 2 }
        ...
        if (random < 30) { imageNo = 0 }
        else if (random < 60) { imageNo = 1 }
        else if (random < 70) { imageNo = 2 }
        else if (random < 100) { imageNo = 3 }
        ...
        if (random < 5) { imageNo = 0 }
        else if (random < 15) { imageNo = 1 }
        else if (random < 25) { imageNo = 2 }
        else if (random < 50) { imageNo = 3 }
        else if (random < 75) { imageNo = 4 }
        else if (random < 100) { imageNo = 5 }
    }
